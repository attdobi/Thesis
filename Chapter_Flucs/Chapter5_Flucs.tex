...
\noindent where F is the Fano factor, F= 0.05 in liquid xenon \cite{FanoTheoretical}, and $\rm r_p$ is the recombination probability. Note, equation \ref{eq:Fano_Intro} will be derived in detail later in this section and is given in equation \ref{eq:SigR}. The recombination probability $\rm r_p$ is equal to the average observed recombination $\rm \left<r\right>$ as the number of events gets large, given in table \ref{table:Fluc_Param}.
...
K-shell X-ray 				& $\sim$32 	 &  52.6 $\pm$ 23 		& 244 $\pm$ 5		& 116 $\pm$ 3 		 & 269 $\pm$ 5						\\ \hline
 $\rm ^{83m}Kr$ 				& 41.55		& 84.2	$\pm$ 0.6			& 171 $\pm$ 0.3		& 51.2 $\pm$	0.3		& 173 $\pm$ 0.2				\\ \hline
