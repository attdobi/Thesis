...
\section{Recombination and Recombination Fluctuations From Tritium Corrected For Spectral Shape}

Once the S1 and S2 has been corrected for spectral shape the recombination fraction r and the recombination fluctuation $\rm \sigma r$ can be extracted from the tritium calibration data. The spectral shape correction will be discussed in further detail in Chapter [].
...
\subcaptionbox{$\rm \sigma r$, 170 V/cm \label{fig:5a}}{\includegraphics[width=73mm]{Chapter_Flucs/Figures/Iter1/std_fig_iter1LY_QY_iter1.eps}}
\hfill
...
\subcaptionbox{Quanta, 100 V/cm \label{fig:5c}}{\includegraphics[width=73mm]{Chapter_Flucs/Figures/Iter1_100/std_fig_100_iter1Tritium_LY_QY_100_iter1.eps}}
\hfill
\subcaptionbox{$\rm \sigma r$, 100 V/cm \label{fig:5c}}{\includegraphics[width=73mm]{Chapter_Flucs/Figures/Iter1_100/quanta_100_iter1.png}}
...
\caption{Recombination Fraction at 170 V/cm (black) and 100 V/cm (blue). The shaded regions represent the one sigma of the observed fluctuations in recombination fractions $\rm \sigma_r$.  }
\label{fig:R_T}
\end{figure}
...
\caption{Extracting alpha from the tritium data by requiring that the observed standard deviation converge with that of a binomial process. On the right, the same concept as the number of ions approaches 1 the fluctuation should be that of a binomial process, that ion will either recombine or not. }
\label{fig:Alpha_T}
\end{figure}


\section{The Big Picture, Recombination Fluctuations}
%Have done the same for the Cs data, show a quick plot of the Cs Quanta and r and sigma R. 
% Explain points from Dahl's thesis...

%make plot of (1-r)/r and var() and compare with Dahl? ... Explain that once we know r and sigma r we can predict the band width (show) with 100 and 170 V/cm
