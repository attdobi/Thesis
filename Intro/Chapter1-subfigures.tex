...
\includegraphics[width=100mm]{Intro/Ch1_Figures/MW_Rotation.png}
...
\subcaptionbox{\label{fig:1a}}{\includegraphics[width=70mm]{Intro/Maru/tiny_box.jpg}}
\hfill
\subcaptionbox{\label{fig:1b}}{\includegraphics[width=70mm]{Intro/Maru/small_box_2.jpg}}


\bigskip

\subcaptionbox{\label{fig:1c}}{\includegraphics[width=70mm]{Intro/Maru/medium_box_2.jpg}}
\hfill
\subcaptionbox{\label{fig:1d}}{\includegraphics[width=70mm]{Intro/Maru/large_box.jpg}}

\caption{Maru the cat explains the cosmic microwave background. Consider that Maru is a photon and the box size represents local energy densities of the universe. The smaller the box size the larger the local energy density and temperature. At the time of last scatter all boxes containing Marus cease to exist, to the horror of of the cats! The Marus are now left to propagate freely through the universe, with their configurations unchanged (the cats are too lazy to move and are content napping for 13.7 billion years). Figures a-d show Maru the cat contained within increasing box sizes corresponding decreasing energy densities.}
\label{fig:CMB_Maru}
\end{figure}
...
\begin{figure}[h!]\centering
\includegraphics[width=100mm]{Intro/Ch1_Figures/BOSS.png}
...
\caption{Illustration of the CP problem and the axion solution. [Carlos' Thesis] }
...
\begin{equation}
\left<\sigma_A \nu \right> \sim \frac{\alpha^2}{m_{weal}^2} \sim 10^{-9} \mathrm{GeV}^{-2}
\end{equation}
...
\begin{figure}[h!]\centering
\includegraphics[width=150mm]{Intro/Ch1_Figures/DM_Detection.png}
\caption{Methods for detecting WIMPs from interactions of q, standard model particles, and dark matter particles $\chi$. }
...
\begin{figure}[h!]\centering
\includegraphics[width=150mm]{Intro/Ch1_Figures/DM_Dist_MW.png}
